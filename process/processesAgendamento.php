                        ...
                        if (in_array($hora, $this->dataDisponiveis)) {
                            ...
                            if ($result->rowCount()) {
                                ...
                                $arquivo = "
                                            ...
                                            <p style='font-size: 18px'>Bem-vindo(a) à <b>QC Estética</b>, $this->usuario! Se você recebeu essa mensagem, é porquê o seu agendamento foi realizado com sucesso para a data $this->data e hora $this->hora. Recomendamos que chegue a clínica com 20 minutos de antecedência</p></br>
