...
<html lang="pt-br">
<head>
<title>QC Estética - Serviços & Produtos</title>
<meta charset="UTF-8">
...
<div class="container" id="produtos1">
    <center>
      ...
      <div class="row" id="produtos_desc2">
          ...
          <p class="textos">O <span class="spans_colorized">Peeling Químico</span> é um tratamento estético eficiente indicado para tratar manchas, marcas de acnes e rugas finas. Utiliza o ácido retinóico sobre a pele na região a ser tratada, causando a descamação e acelerando o processo de renovação celular.</p>
        ...
        <div id="produto5" class="col-sm-4">
            ...
            <span class="spans_produtos">Rejuvenescimento</span><br><br>
          <p class="textos">O <span class="spans_colorized">Peeling de Diamante</span> é um tratamento que proporciona uma leve esfoliação para a remoção da camada superior de pele morta, contribuindo para uma melhor circulação sanguínea e uma pele mais elástica, suave e fresca.</p>
      ...
      <button id="bttn_maisprodutos_esteticos" class="btn btn-primary">Ver outros produtos...</button><br>
...
<!----------------------------------------------------- Tratamentos Corporais -------------------------------------------------------------------------------------------------->
      ...
      <button id="bttn_maisprodutos_corporal" class="btn btn-primary">Ver outros produtos...</button><br>
...
<!-- Modais de descrição dos produtos -->
<div class="modal fade" id="modalProduto1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <button id="bttn_saibamenos_produto1" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Toxina Botulínica</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto2" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Preenchimento</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto3" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Peeling Químico</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto4" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Peeling de Diamante</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto5" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Fios de PDO</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto6" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Procedimento Estético Injetável em Microvasos (Secagem de vasinhos)</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto7" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto8" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Bioestimulador de colágeno</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto8" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Skinbooster</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto9" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Limpeza de Pele</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto10" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Mesoterapia Capilar</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto11" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="modalProduto12" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <b><h5 class="titulos_produtos">➤ Intradermoterapia ou Mesoterapia Facial</h5></b>
      ...
      <div class="modal-footer">
      <button id="bttn_saibamenos_produto12" class="btn btn-primary">Entendi</button><br>
      </div>
    </div>
  </div>
</div>
