...
<div class="col-sm-6" id="form_login">
  <form id="frmLogin">
      ...
      <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
			...
			<input type="password" placeholder="Digite sua senha de usuário..." id="passwd" name="passwd" required><img src="" alt="">
      
      <svg id="showPass" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="rgba(139,0,139,1)" class="bi bi-eye-fill" viewBox="0 0 16 16">
      <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
      <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
      </svg> 
      <svg id="hidePass" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="rgba(139,0,139,1)" class="bi bi-eye-slash-fill" viewBox="0 0 16 16">
