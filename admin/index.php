...
<div class="col-sm-12" id="form_login">
  <form id="frmLogin">
		<div class="container">
			...
			<input type="email" id="email" placeholder="Digite seu email de administrador..." name="email" required> 
            ...
            <input type="password" id="passwd" placeholder="Digite sua senha de administrador..." name="senha" required>
